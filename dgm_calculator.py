...
INCERTEZA_KV_PERCENTUAL = 0.0001  # ±1%
INCERTEZA_MAS_PERCENTUAL = 0.005 # ±5%
INCERTEZA_ESPESSURA_PERCENTUAL = 0.002 # ±0,2% (considerando 1 a 2mm como 2% a 5% de 2 a 11cm)
...
def calcular_fator_c(csr, espessura, glandularidade, d_espessura_abs):
    try:
        ...
        # Mapeamento manual dos coeficientes para cada entrada no formulas_fator_c
        # Esta é a parte "hacky" para obter os coeficientes sem reestruturar o dicionário global
